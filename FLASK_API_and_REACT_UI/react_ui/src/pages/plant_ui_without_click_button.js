    ...
    <div style={{
      ...
      <div style={{ background: 'blue', border: '1px solid #ccc', marginBottom: '20px' }}>
        <h1 style={{ textAlign: 'center', color: 'white' }}>
          Potato Plant Disease Prediction with Artificial Intelligence (Tensorflow)
        </h1>
      </div>
      ...
      <div style={{
        ...
        <Link to="/plant_classification_Pytorch_project_ui" style={{color:'white'}}>plant_classification_Pytorch_project_ui</Link>
      </div>
    </div>
  );
}
